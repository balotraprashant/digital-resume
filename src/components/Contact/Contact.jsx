                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="mt-2">
                                ...
                                <div className="pb-2 text-secondary">Gurgaon, Haryana, India</div>
                                <h3 className="h6">Phone</h3>
                                <div className="pb-2 text-secondary">+91 700-659-3003</div>
                                <h3 className="h6">Email</h3>
                                <div className="pb-2 text-secondary">balotra.prashant@gmail.com</div>
                            </div>
                        </div>
